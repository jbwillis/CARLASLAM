...
def add_lidar_sensor(world, vehicle, sensor_data):
    ...
    sensor.listen(lambda data: sensor_data.add_data(handle_lidar(data)))
...
def main():
    ...
    try:
        ...
        lidar = add_lidar_sensor(world, vehicle, sensor_data)
